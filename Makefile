...
lint: ## check style with flake8
	flake8 kafka_schema_registry_admin tests
...
coverage: ## check code coverage quickly with the default Python
	coverage run --source kafka_schema_registry_admin -m pytest
	coverage report -m
	coverage html
	$(BROWSER) htmlcov/index.html

docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/kafka_schema_registry_admin.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ kafka_schema_registry_admin
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
